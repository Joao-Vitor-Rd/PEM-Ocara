export class Assistida {
    constructor(nome, idade, identidadeGenero, nomeSocial, endereco, escolaridade, religiao, nacionalidade, zonaHabitacao, profissao, limitacaoFisica, numeroCadastroSocial, temDependentes) {
        this.casos = [];
